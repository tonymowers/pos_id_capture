...
namespace CH.Alika.POS.Hardware
{
    ...
    {
        private static readonly ILog log = LogProvider.For<MMMDocumentScanner>();
        ...
        {
            log.Info("Activating 3M Document Scanner");
        ...
        {
            log.Info("Intializing Swipe Reader");
            log.Debug("Swipe Reader Settings : [" + swipeSettings + "]");
        ...
        public void Dispose()
        {
            log.Info("Disposing of scanner");
            MMM.Readers.Modules.Swipe.Shutdown();
            log.Info("Disposing of scanner completed");
        }
